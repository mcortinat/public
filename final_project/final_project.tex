...
\textbf{AZ Comments on Data section:} This looks like great progress to me. You should write in the present tense. For the final project, edit this so that it more closely aligns with how data sections look in published work. For example, no bullet point lists. Even if you do not have all the data or IRB approval, you can still rewrite things so that there are complete paragraphs. This will not require too much as the section does not need to be long. You have most of the information there already. 
