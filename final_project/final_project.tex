...
Women have historically been underrepresented in several professional careers. Specifically, there is low female representation in careers related to mathematics, science, economics, and computer science. Women tend to prefer arts and humanities careers over those just mentioned \citep{bettinger_faculty_2005, wiswall_determinants_2013}.

Although the situation of women in the academic and workplace world has evolved, something special is happening in economics. For multiple reasons, women tend not to choose it. Although female participation in STEM careers has increased in recent years, economics continues to lag behind. In the United States, only a third of the bachelor’s degrees in economics are awarded to women, while in STEM majors this percentage reaches almost 60\%. In Figure 1, the stability of this share in economics over the last two decades contrasts with the growth observed in other sciences. Similarly, in the realm of PhDs, economics has consistently awarded approximately one-third to women, diverging significantly from STEM fields where the proportion is 56\% \citep{bayer_diversity_2016}. Notably, the gender gap in economics surpasses that of other disciplines.
In the leading five economics schools globally \citep{megraoui2019}, female representation among faculty members remains below 20\%. On average, it stands at 15\%, specifically 15.78\% at Harvard, 15.38\% at MIT, 12.5\% at Stanford, 19.27\% at Berkeley, and 12.5\% at Chicago. Remarkably, Esther Duflo is one of the two women in the top 100 most cited economists on ideas.repec.org (October 2025)\footnote{https://ideas.repec.org/top/top.person.nbcites.html}. Moreover, she is one of three women to have received the Nobel Prize in Economics, out of 57 prizes awarded to 99 laureates between 1969 and 2025.

A growing body of literature has been devoted to exploring this question: what is driving women away from economics? Is it an unattractive career for women? Or do they have fewer opportunities to develop in it? \citet{dynan_underrepresentation_1997} highlighted that women often enter college with preconceived notions about economics as a career, leading them to dismiss it from their options early on. A survey conducted among female college seniors revealed that when asked why they had not enrolled in a Principles of Economics course, female students were more than twice as likely as their male counterparts to cite a lack of interest in economics as the reason. Perceived interest in a subject is considered key in career choice \citep{calkins_factors_2006}, and women tend to have a more negative predisposition towards economics than men \citep{bansak_gender_2010}. Even so, there are studies that show that they do not differ in performance relative to boys in introductory courses \citep{bollinger_chicks_2009}.

Further evidence suggests that women in economics exhibit stronger writing skills than men. However, they face higher publication standards in journal reviews. Additionally, female economists spend an extra six months in the review process for the most esteemed journals compared to their male counterparts \citep{hengel_publishing_2022}. Furthermore, research indicates that despite similar productivity levels, women are less likely to progress in academic careers \citep{wolfers_how_nodate}. Moreover, in seminar settings, women encounter a greater number of questions, often of a more antagonistic nature, compared to men \citep{dupas_gender_2021}.

Along the same lines, \citet{wu_gendered_2018} analyzed the comments of an economic forum called EconJobRumors.com. The forum works as a tool to share information about job opportunities and recommendations from colleagues within the profession, through comments posted anonymously and in an informal way. The study found that while comments were more likely to describe men with words like “advisor,” “mathematician,” “Nobel,” and “macroeconomics,” women were more likely to be described as “hot,” “beautiful,” “married,” “pregnant,” and other physical and family-related characteristics.

Considering the issues previously highlighted, the limited presence of female teachers in economics among undergraduate students becomes a concerning factor. This situation is alarming as the male dominance within a field often dissuades women from pursuing it, and the absence of exposure to successful female figures might lead younger women to believe they won't thrive in that domain \citep{blau_economics_2010}. Notably, a profession-wide survey identified key factors contributing to the underrepresentation of women in economics: the perception among women that there's a scarcity of role models and their lack of confidence in their abilities within the field \citep{haslehurst_not_1998}.

This study delves deeper into whether teaching assistants can serve as viable role models, particularly examining if female teaching assistants can inspire their female students to pursue economics. Effective role models possess specific traits that influence those observing them. They must embody possibility and inspiration \citep{morgenroth_motivational_2015}. Moreover, the observer must relate to the model, sharing similar contexts. Teaching assistants, as students themselves, typically demonstrate exceptional performance in the subject they teach, possess experience, and offer guidance in answering questions. Unlike teachers, teaching assistants’ proximity in age to students significantly aids in fostering a more relatable and identifiable connection with them.

In this context, I conducted research within the Commercial Engineering program at a Chilean university to explore the choice between Economics and Business Administration majors. The primary focus of this study is to empirically assess whether exposure to female teaching assistants influences the likelihood of female students opting for Economics relative to male students. To examine the impact of role models, I compared male and female students, hypothesizing that, given the prevalent male dominance in the field of economics, the gender of the role model holds significance for female students' identification—specifically, with their female teaching assistants.

To identify the effect of role models, I compare male and female students who took the same courses, focusing on whether each student was exposed to at least one female teaching assistant in the relevant area. The key variation comes from the fact that some students, within the same course and cohort, had a female assistant and others did not. Since the assignment of assistants takes place after students enroll, it is plausibly unrelated to students’ own preferences for Economics. However, there is still a potential concern regarding non-random assignment if teachers have gender preferences when selecting their assistants. I explore this possibility by examining patterns in the assistant selection process.
...
Table 2 presents the estimates from the linear probability models for each course. In every specification, the dependent variable is a dummy equal to 1 if the student enrolled in Mathematical Economics (the Economics major). Across all regressions, the coefficient on the Female dummy is negative, indicating that female students are, on average, less likely than male students to choose the Economics track. The treatment indicator (T), which captures having at least one female assistant in the respective course, is small in magnitude and not statistically significant.

The main parameter of interest is the interaction term (T × Female), which measures whether exposure to a female TA affects female students differently than male students. Although none of the interaction coefficients are statistically significant, their signs and magnitudes provide useful preliminary information. The interaction terms are positive in almost all courses, with values ranging from about –0.01 to +0.03. Given the low baseline enrollment rate in the Economics major (9.81\%), even a coefficient around 0.03 corresponds to an effect of roughly three percentage points, about a 30\% increase relative to the baseline probability. In the course-level results, the largest positive interaction effects appear in Microeconomics I and Calculus I/II, where the estimates fall around 0.028–0.031. Although imprecisely estimated, these magnitudes suggest that, if a role-model effect exists, it could be economically meaningful.

Table 3 shows the aggregated results in which the treatment is defined at the broader area level rather than for individual courses. The patterns are similar: the Female dummy remains negative, the treatment dummy is small, and the interaction coefficients are again positive but not statistically significant. The magnitudes are somewhat smaller in these broader specifications. The coefficient for the Economics area is 0.019, which corresponds to about a 19\% increase relative to the baseline probability, while the effect for the Mathematics area is around 0.012 (approximately 12\% of the baseline).

Taken together, these preliminary results do not provide statistically significant evidence that exposure to female teaching assistants increases female students’ probability of choosing the Economics major. However, the consistently positive signs of the interaction terms, combined with effect sizes that are non-negligible relative to the low baseline enrollment rate, suggest that the potential role-model effect is not trivial and may require additional data, stronger treatment variation, or alternative specifications to be detected more precisely.

\begin{table}[H]
	\centering
	\caption{Effect of Female Teaching Assistants on Economics Track Enrollment}
	\label{tab:courses}
	\input{table_courses.tex}
\end{table}

\begin{table}[H]
	\centering
	\caption{Aggregated Effects of Female Teaching Assistants}
	\label{tab:aggregated}
	\input{table_aggregated.tex}
\end{table}
