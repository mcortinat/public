...
Prior to demolition, the average public housing household in the sample lived in a Census tract with a poverty rate of 83 percent.
...
\vspace{3mm}
	...
	\begin{frame}{Data}
		...
		\begin{itemize}
			...
			\item 20 buildings were demolished (treated) and 33 remained open and serve as controls.
		\end{itemize}
		Households:
		\begin{itemize}
			...
			\item It covered at least 73\% of households in the demolition sample.
	...
	The design requires that demolition was not correlated with children’s baseline
characteristics.
        \centering
		\includegraphics[width=0.5\linewidth]{table1}
		% significance is |t|= coeff/SE > 2.56 for 1%.
	\end{frame}
...
\begin{columns}[c] 
		...
		\centering
		\includegraphics[width=1.2\linewidth]{fig1}
		\end{column}
	\begin{column}{0.45\textwidth}
	\begin{itemize}
		\item Displaced households → shifted left distribution
		\item More years spent in lower-poverty neighborhoods
		\item 44\% lived in tracts <40\% poverty (vs. much lower share in control)
	\end{itemize}
	\end{column}
\end{columns}	
	\end{frame}
...
\begin{frame}{Main Results: Effects on Labor Market Activity}
		...
		\centering
			\includegraphics[width=0.7\linewidth]{table3}
		\end{frame}
		
\begin{frame}{Main Results: Effects on Labor Market Activity}
			\centering
			\includegraphics[width=0.8\linewidth]{table4}
\end{frame}
	...
	\begin{frame}{Main Results: Effects on Labor Market Activity}
		...
		%	\item Displaced children are more likely to be employed (about +4 p.p., 9\%) and earn more as adults (around +\$600, 16\%); they are also more likely to earn above \$14,000.
			\item Children exposed to better neighborhoods earn more and are more likely to work in adulthood.
...
%	\end{frame}
	...
	% ---------- SLIDE 7.4----------	
\begin{frame}{Main results: Effect of Years in Public Housing (2SLS)}
	Staying longer in public housing reduces labor market success in adulthood
	
	\centering
	\includegraphics[width=0.55\linewidth]{table6}
	% Use demolition as an instrument for years spent in high-rise public housing
	% Interpretation: causal effect of an extra year in project-based public housing on adult outcomes
	% panel a: demolition implies 2.6 years less in the public housing system
	% pabel b: each extra year in public housing reduces employment by 1.9pp and annual earnings by $277
\end{frame}
